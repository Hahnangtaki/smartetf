...
public class EtfExecution implements Serializable {
    ...
    @OneToMany(mappedBy = "execute")
    private Set<EtfExecutionDtl> executeDtls = new HashSet<>();
    ...
    public Set<EtfExecutionDtl> getExecuteDtls() {
        return executeDtls;
    }

    public EtfExecution executeDtls(Set<EtfExecutionDtl> etfExecutionDtls) {
        this.executeDtls = etfExecutionDtls;
        return this;
    }

    public EtfExecution addExecuteDtl(EtfExecutionDtl etfExecutionDtl) {
        this.executeDtls.add(etfExecutionDtl);
        etfExecutionDtl.setExecute(this);
        return this;
    }

    public EtfExecution removeExecuteDtl(EtfExecutionDtl etfExecutionDtl) {
        this.executeDtls.remove(etfExecutionDtl);
        etfExecutionDtl.setExecute(null);
        return this;
    }

    public void setExecuteDtls(Set<EtfExecutionDtl> etfExecutionDtls) {
        this.executeDtls = etfExecutionDtls;
    }
