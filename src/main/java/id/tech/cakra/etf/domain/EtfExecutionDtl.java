...
public class EtfExecutionDtl implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("executeDtls")
    private EtfExecution execute;
    ...
    public EtfExecution getExecute() {
        return execute;
    }

    public EtfExecutionDtl execute(EtfExecution etfExecution) {
        this.execute = etfExecution;
        return this;
    }

    public void setExecute(EtfExecution etfExecution) {
        this.execute = etfExecution;
    }
