...
public class Redemption implements Serializable {
    ...
    public Redemption redemptionId(Integer redemptionId) {
    ...
    public Redemption dealerId(Integer dealerId) {
    ...
    public Redemption productId(Integer productId) {
    ...
    public Redemption underlyingId(Integer underlyingId) {
