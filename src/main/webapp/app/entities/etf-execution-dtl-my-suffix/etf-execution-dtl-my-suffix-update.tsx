          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : etfExecutionDtlEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="etf-execution-dtl-my-suffix-execute">Execute</Label>
                  <AvInput id="etf-execution-dtl-my-suffix-execute" type="select" className="form-control" name="executeId">
                    <option value="" key="0" />
                    {etfExecutions
