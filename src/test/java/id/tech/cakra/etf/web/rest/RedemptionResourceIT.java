...
public class RedemptionResourceIT {
    ...
    private static final Integer DEFAULT_REDEMPTION_ID = 1;
    private static final Integer UPDATED_REDEMPTION_ID = 2;
    private static final Integer SMALLER_REDEMPTION_ID = 1 - 1;
    ...
    public static Redemption createEntity(EntityManager em) {
        Redemption redemption = new Redemption()
            .redemptionId(DEFAULT_REDEMPTION_ID)
    ...
    public static Redemption createUpdatedEntity(EntityManager em) {
        Redemption redemption = new Redemption()
            .redemptionId(UPDATED_REDEMPTION_ID)
    ...
    public void createRedemption() throws Exception {
        ...
        assertThat(testRedemption.getRedemptionId()).isEqualTo(DEFAULT_REDEMPTION_ID);
        ...
        assertThat(testRedemption.getDealerId()).isEqualTo(DEFAULT_DEALER_ID);
        assertThat(testRedemption.getProductId()).isEqualTo(DEFAULT_PRODUCT_ID);
        assertThat(testRedemption.getUnderlyingId()).isEqualTo(DEFAULT_UNDERLYING_ID);
    }
    ...
    public void getAllRedemptions() throws Exception {
        ...
        restRedemptionMockMvc.perform(get("/api/redemptions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].redemptionId").value(hasItem(DEFAULT_REDEMPTION_ID)))
    ...
    public void getRedemption() throws Exception {
        ...
        restRedemptionMockMvc.perform(get("/api/redemptions/{id}", redemption.getId()))
            ...
            .andExpect(jsonPath("$.redemptionId").value(DEFAULT_REDEMPTION_ID))
    ...
    public void updateRedemption() throws Exception {
        ...
        Redemption testRedemption = redemptionList.get(redemptionList.size() - 1);
        assertThat(testRedemption.getRedemptionId()).isEqualTo(UPDATED_REDEMPTION_ID);
        ...
        assertThat(testRedemption.getDealerId()).isEqualTo(UPDATED_DEALER_ID);
        assertThat(testRedemption.getProductId()).isEqualTo(UPDATED_PRODUCT_ID);
        assertThat(testRedemption.getUnderlyingId()).isEqualTo(UPDATED_UNDERLYING_ID);
    }
