...
public class EtfHistoryResourceIT {
    ...
    public void createEtfHistory() throws Exception {
        ...
        assertThat(testEtfHistory.getProductId()).isEqualTo(DEFAULT_PRODUCT_ID);
    ...
    public void checkProductIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = etfHistoryRepository.findAll().size();
        // set the field null
        etfHistory.setProductId(null);

        // Create the EtfHistory, which fails.
        EtfHistoryDTO etfHistoryDTO = etfHistoryMapper.toDto(etfHistory);
        ...
        List<EtfHistory> etfHistoryList = etfHistoryRepository.findAll();
        assertThat(etfHistoryList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void updateEtfHistory() throws Exception {
        ...
        EtfHistory testEtfHistory = etfHistoryList.get(etfHistoryList.size() - 1);
        assertThat(testEtfHistory.getProductId()).isEqualTo(UPDATED_PRODUCT_ID);
